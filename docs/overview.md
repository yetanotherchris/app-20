...
- Display assistant responses as left-aligned, unboxed text in a centered conversation column, following [spec 007](../specs/007-chat-reference-presentation/spec.md).
