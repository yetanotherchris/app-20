...
Consolidate reusable decisions from the iOS design package into the guide. Keep geometry, exact copy, and iOS-only native behavior in the iOS visual specification. The guide links the two documents and assigns cross-platform meaning to the guide.
